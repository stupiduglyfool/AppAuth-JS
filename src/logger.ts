...
export const profile = (target: any, propertyKey: string, descriptor: PropertyDescriptor) => {
     ...
     // return as-is
     return IS_PROFILE ? performProfile(target, propertyKey, descriptor) : descriptor;
...
const performProfile = (target: any, propertyKey: string, descriptor: PropertyDescriptor) => {

     let originalCallable = descriptor.value;
     // name must exist
     let name = originalCallable.name || 'anonymous function';
